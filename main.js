...
function generateCodeLine(r, b){
    const codeLineHtml = `<div class="line-container"><div class="code-line-number"></div><div class="code-line-blue" style="flex-grow:${b}"></div><div class="code-line-red" style="flex-grow:${r}"></div>
</div>`;
return codeLineHtml;
}
const lineAmount = 0;
for(let i = 0; i < lineAmount; i+=1){
    codeContainer.innerHTML += generateCodeLine(codeLength[i].red,codeLength[i].blue);
}
*/
